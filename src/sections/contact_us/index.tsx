...
export function ContactUs() {
    return (
        <section className="flex flex-col pb-[70px] pt-[100px]">
            ...
            <div className="bg-gray rounded-[45px] flex items-start justify-between py-[60px] px-[100px] space-x-[210px] overflow-hidden">
                <form action="" className="flex flex-1 flex-col items-start justify-stretch ">
                    <fieldset className="flex items-center justify-center gap-9 mb-[40px]">
                ...
                <img src="./Illustration_3.png" alt="illustration" className="-mr-[110px] object-contain"/>
            </div>
        </section>
    )
}